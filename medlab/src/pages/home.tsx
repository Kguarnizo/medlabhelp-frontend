...
const Homepage: React.FC = () => {
    ...
    <div>
        ...
        <Carousel id='carousel-images'>
            <Carousel.Item>
            <img src="images/cdc-XLhDvfz0sUM-unsplash.jpg" alt="First slide"/>
            </Carousel.Item>
            <Carousel.Item>
            <img src="images/cdc-CfS6A4U5g8M-unsplash.jpg" alt="Second slide"/>
            </Carousel.Item>
            <Carousel.Item>
            <img src="images/testalize-me-0jE8ynV4mis-unsplash.jpg" alt="Third slide"/>
            </Carousel.Item>
            </Carousel>
        </div>
